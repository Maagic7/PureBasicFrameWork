...
DeclareModule Snap7
  ...
  ;- ------------------------------
  ;- Server Prototype (server is to simulate a S7 PLC)
  ;  ------------------------------
  ...
  Declare snap7_CloseDLL()
  Declare.i snap7_OpenDLL()
...
Module Snap7
  ...
  CompilerSelect  #PB_Compiler_OS 
    ...
    CompilerCase #PB_OS_Linux
      ...
      CompilerIf #PB_Compiler_32Bit
        #_Snap7_FileName = "snap7.lib"        
      CompilerElse
         #_Snap7_FileName = "snap7.lib"
      CompilerEndIf
     
    CompilerCase #PB_OS_MacOS
      CompilerError "snap7 PLC library do not support Mac OSX"
  ...
  Procedure.i snap7_OpenDLL()
    ...
    hDLL = OpenLibrary(#PB_Any, #_Snap7_FileName)
    
    If hDLL = 0
      MessageRequester("Error!", "Can not load " + #_Snap7_FileName)
      ProcedureReturn #False
    EndIf
  
    Cli_ABRead.Cli_ABRead=GetFunction(hDLL,"Cli_ABRead")
    Cli_ABWrite.Cli_ABWrite=GetFunction(hDLL,"Cli_ABWrite")
    Cli_AsABRead.Cli_AsABRead=GetFunction(hDLL,"Cli_AsABRead")
    Cli_AsABWrite.Cli_AsABWrite=GetFunction(hDLL,"Cli_AsABWrite")
    Cli_AsCTRead.Cli_AsCTRead=GetFunction(hDLL,"Cli_AsCTRead")
    Cli_AsCTWrite.Cli_AsCTWrite=GetFunction(hDLL,"Cli_AsCTWrite")
    Cli_AsCompress.Cli_AsCompress=GetFunction(hDLL,"Cli_AsCompress")
    Cli_AsCopyRamToRom.Cli_AsCopyRamToRom=GetFunction(hDLL,"Cli_AsCopyRamToRom")
    Cli_AsDBFill.Cli_AsDBFill=GetFunction(hDLL,"Cli_AsDBFill")
    Cli_AsDBGet.Cli_AsDBGet=GetFunction(hDLL,"Cli_AsDBGet")
    Cli_AsDBRead.Cli_AsDBRead=GetFunction(hDLL,"Cli_AsDBRead")
    Cli_AsDBWrite.Cli_AsDBWrite=GetFunction(hDLL,"Cli_AsDBWrite")
    Cli_AsDownload.Cli_AsDownload=GetFunction(hDLL,"Cli_AsDownload")
    Cli_AsEBRead.Cli_AsEBRead=GetFunction(hDLL,"Cli_AsEBRead")
    Cli_AsEBWrite.Cli_AsEBWrite=GetFunction(hDLL,"Cli_AsEBWrite")
    Cli_AsFullUpload.Cli_AsFullUpload=GetFunction(hDLL,"Cli_AsFullUpload")
    Cli_AsListBlocksOfType.Cli_AsListBlocksOfType=GetFunction(hDLL,"Cli_AsListBlocksOfType")
    Cli_AsMBRead.Cli_AsMBRead=GetFunction(hDLL,"Cli_AsMBRead")
    Cli_AsMBWrite.Cli_AsMBWrite=GetFunction(hDLL,"Cli_AsMBWrite")
    Cli_AsReadArea.Cli_AsReadArea=GetFunction(hDLL,"Cli_AsReadArea")
    Cli_AsReadSZL.Cli_AsReadSZL=GetFunction(hDLL,"Cli_AsReadSZL")
    Cli_AsReadSZLList.Cli_AsReadSZLList=GetFunction(hDLL,"Cli_AsReadSZLList")
    Cli_AsTMRead.Cli_AsTMRead=GetFunction(hDLL,"Cli_AsTMRead")
    Cli_AsTMWrite.Cli_AsTMWrite=GetFunction(hDLL,"Cli_AsTMWrite")
    Cli_AsUpload.Cli_AsUpload=GetFunction(hDLL,"Cli_AsUpload")
    Cli_AsWriteArea.Cli_AsWriteArea=GetFunction(hDLL,"Cli_AsWriteArea")
    Cli_CTRead.Cli_CTRead=GetFunction(hDLL,"Cli_CTRead")
    Cli_CTWrite.Cli_CTWrite=GetFunction(hDLL,"Cli_CTWrite")
    Cli_CheckAsCompletion.Cli_CheckAsCompletion=GetFunction(hDLL,"Cli_CheckAsCompletion")
    Cli_ClearSessionPassword.Cli_ClearSessionPassword=GetFunction(hDLL,"Cli_ClearSessionPassword")
    Cli_Compress.Cli_Compress=GetFunction(hDLL,"Cli_Compress")
    Cli_Connect.Cli_Connect=GetFunction(hDLL,"Cli_Connect")
    Cli_ConnectTo.Cli_ConnectTo=GetFunction(hDLL,"Cli_ConnectTo")
    Cli_CopyRamToRom.Cli_CopyRamToRom=GetFunction(hDLL,"Cli_CopyRamToRom")
    Cli_Create.Cli_Create=GetFunction(hDLL,"Cli_Create")
    Cli_DBFill.Cli_DBFill=GetFunction(hDLL,"Cli_DBFill")
    Cli_DBGet.Cli_DBGet=GetFunction(hDLL,"Cli_DBGet")
    Cli_DBRead.Cli_DBRead=GetFunction(hDLL,"Cli_DBRead")
    Cli_DBWrite.Cli_DBWrite=GetFunction(hDLL,"Cli_DBWrite")
    Cli_Delete.Cli_Delete=GetFunction(hDLL,"Cli_Delete")
    Cli_Destroy.Cli_Destroy=GetFunction(hDLL,"Cli_Destroy")
    Cli_Disconnect.Cli_Disconnect=GetFunction(hDLL,"Cli_Disconnect")
    Cli_Download.Cli_Download=GetFunction(hDLL,"Cli_Download")
    Cli_EBRead.Cli_EBRead=GetFunction(hDLL,"Cli_EBRead")
    Cli_EBWrite.Cli_EBWrite=GetFunction(hDLL,"Cli_EBWrite")
    Cli_ErrorText.Cli_ErrorText=GetFunction(hDLL,"Cli_ErrorText")
    Cli_FullUpload.Cli_FullUpload=GetFunction(hDLL,"Cli_FullUpload")
    Cli_GetAgBlockInfo.Cli_GetAgBlockInfo=GetFunction(hDLL,"Cli_GetAgBlockInfo")
    Cli_GetConnected.Cli_GetConnected=GetFunction(hDLL,"Cli_GetConnected")
    Cli_GetCpInfo.Cli_GetCpInfo=GetFunction(hDLL,"Cli_GetCpInfo")
    Cli_GetCpuInfo.Cli_GetCpuInfo=GetFunction(hDLL,"Cli_GetCpuInfo")
    Cli_GetExecTime.Cli_GetExecTime=GetFunction(hDLL,"Cli_GetExecTime")
    Cli_GetLastError.Cli_GetLastError=GetFunction(hDLL,"Cli_GetLastError")
    Cli_GetOrderCode.Cli_GetOrderCode=GetFunction(hDLL,"Cli_GetOrderCode")
    Cli_GetParam.Cli_GetParam=GetFunction(hDLL,"Cli_GetParam")
    Cli_GetPduLength.Cli_GetPduLength=GetFunction(hDLL,"Cli_GetPduLength")
    Cli_GetPgBlockInfo.Cli_GetPgBlockInfo=GetFunction(hDLL,"Cli_GetPgBlockInfo")
    Cli_GetPlcDateTime.Cli_GetPlcDateTime=GetFunction(hDLL,"Cli_GetPlcDateTime")
    Cli_GetPlcStatus.Cli_GetPlcStatus=GetFunction(hDLL,"Cli_GetPlcStatus")
    Cli_GetProtection.Cli_GetProtection=GetFunction(hDLL,"Cli_GetProtection")
    Cli_IsoExchangeBuffer.Cli_IsoExchangeBuffer=GetFunction(hDLL,"Cli_IsoExchangeBuffer")
    Cli_ListBlocks.Cli_ListBlocks=GetFunction(hDLL,"Cli_ListBlocks")
    Cli_ListBlocksOfType.Cli_ListBlocksOfType=GetFunction(hDLL,"Cli_ListBlocksOfType")
    Cli_MBRead.Cli_MBRead=GetFunction(hDLL,"Cli_MBRead")
    Cli_MBWrite.Cli_MBWrite=GetFunction(hDLL,"Cli_MBWrite")
    Cli_PlcColdStart.Cli_PlcColdStart=GetFunction(hDLL,"Cli_PlcColdStart")
    Cli_PlcHotStart.Cli_PlcHotStart=GetFunction(hDLL,"Cli_PlcHotStart")
    Cli_PlcStop.Cli_PlcStop=GetFunction(hDLL,"Cli_PlcStop")
    Cli_ReadArea.Cli_ReadArea=GetFunction(hDLL,"Cli_ReadArea")
    Cli_ReadMultiVars.Cli_ReadMultiVars=GetFunction(hDLL,"Cli_ReadMultiVars")
    Cli_ReadSZL.Cli_ReadSZL=GetFunction(hDLL,"Cli_ReadSZL")
    Cli_ReadSZLList.Cli_ReadSZLList=GetFunction(hDLL,"Cli_ReadSZLList")
    Cli_SetAsCallback.Cli_SetAsCallback=GetFunction(hDLL,"Cli_SetAsCallback")
    Cli_SetConnectionParams.Cli_SetConnectionParams=GetFunction(hDLL,"Cli_SetConnectionParams")
    Cli_SetConnectionType.Cli_SetConnectionType=GetFunction(hDLL,"Cli_SetConnectionType")
    Cli_SetParam.Cli_SetParam=GetFunction(hDLL,"Cli_SetParam")
    Cli_SetPlcDateTime.Cli_SetPlcDateTime=GetFunction(hDLL,"Cli_SetPlcDateTime")
    Cli_SetPlcSystemDateTime.Cli_SetPlcSystemDateTime=GetFunction(hDLL,"Cli_SetPlcSystemDateTime")
    Cli_SetSessionPassword.Cli_SetSessionPassword=GetFunction(hDLL,"Cli_SetSessionPassword")
    Cli_TMRead.Cli_TMRead=GetFunction(hDLL,"Cli_TMRead")
    Cli_TMWrite.Cli_TMWrite=GetFunction(hDLL,"Cli_TMWrite")
    Cli_Upload.Cli_Upload=GetFunction(hDLL,"Cli_Upload")
    Cli_WaitAsCompletion.Cli_WaitAsCompletion=GetFunction(hDLL,"Cli_WaitAsCompletion")
    Cli_WriteArea.Cli_WriteArea=GetFunction(hDLL,"Cli_WriteArea")
    Cli_WriteMultiVars.Cli_WriteMultiVars=GetFunction(hDLL,"Cli_WriteMultiVars")
   
    Srv_ClearEvents.Srv_ClearEvents=GetFunction(hDLL,"Srv_ClearEvents")
    Srv_Create.Srv_Create=GetFunction(hDLL,"Srv_Create")
    Srv_Destroy.Srv_Destroy=GetFunction(hDLL,"Srv_Destroy")
    Srv_ErrorText.Srv_ErrorText=GetFunction(hDLL,"Srv_ErrorText")
    Srv_EventText.Srv_EventText=GetFunction(hDLL,"Srv_EventText")
    Srv_GetMask.Srv_GetMask=GetFunction(hDLL,"Srv_GetMask")
    Srv_GetParam.Srv_GetParam=GetFunction(hDLL,"Srv_GetParam")
    Srv_GetStatus.Srv_GetStatus=GetFunction(hDLL,"Srv_GetStatus")
    Srv_LockArea.Srv_LockArea=GetFunction(hDLL,"Srv_LockArea")
    Srv_PickEvent.Srv_PickEvent=GetFunction(hDLL,"Srv_PickEvent")
    Srv_RegisterArea.Srv_RegisterArea=GetFunction(hDLL,"Srv_RegisterArea")
    Srv_SetCpuStatus.Srv_SetCpuStatus=GetFunction(hDLL,"Srv_SetCpuStatus")
    Srv_SetEventsCallback.Srv_SetEventsCallback=GetFunction(hDLL,"Srv_SetEventsCallback")
    Srv_SetMask.Srv_SetMask=GetFunction(hDLL,"Srv_SetMask")
    Srv_SetParam.Srv_SetParam=GetFunction(hDLL,"Srv_SetParam")
    Srv_SetRWAreaCallback.Srv_SetRWAreaCallback=GetFunction(hDLL,"Srv_SetRWAreaCallback")
    Srv_SetReadEventsCallback.Srv_SetReadEventsCallback=GetFunction(hDLL,"Srv_SetReadEventsCallback")
    Srv_Start.Srv_Start=GetFunction(hDLL,"Srv_Start")
    Srv_StartTo.Srv_StartTo=GetFunction(hDLL,"Srv_StartTo")
    Srv_Stop.Srv_Stop=GetFunction(hDLL,"Srv_Stop")
    Srv_UnlockArea.Srv_UnlockArea=GetFunction(hDLL,"Srv_UnlockArea")
    Srv_UnregisterArea.Srv_UnregisterArea=GetFunction(hDLL,"Srv_UnregisterArea") 
   
    Par_AsBSend.Par_AsBSend=GetFunction(hDLL,"Par_AsBSend")
    Par_BRecv.Par_BRecv=GetFunction(hDLL,"Par_BRecv")
    Par_BSend.Par_BSend=GetFunction(hDLL,"Par_BSend")
    Par_CheckAsBRecvCompletion.Par_CheckAsBRecvCompletion=GetFunction(hDLL,"Par_CheckAsBRecvCompletion")
    Par_CheckAsBSendCompletion.Par_CheckAsBSendCompletion=GetFunction(hDLL,"Par_CheckAsBSendCompletion")
    Par_Create.Par_Create=GetFunction(hDLL,"Par_Create")
    Par_Destroy.Par_Destroy=GetFunction(hDLL,"Par_Destroy")
    Par_ErrorText.Par_ErrorText=GetFunction(hDLL,"Par_ErrorText")
    Par_GetLastError.Par_GetLastError=GetFunction(hDLL,"Par_GetLastError")
    Par_GetParam.Par_GetParam=GetFunction(hDLL,"Par_GetParam")
    Par_GetStats.Par_GetStats=GetFunction(hDLL,"Par_GetStats")
    Par_GetStatus.Par_GetStatus=GetFunction(hDLL,"Par_GetStatus")
    Par_GetTimes.Par_GetTimes=GetFunction(hDLL,"Par_GetTimes")
    Par_SetParam.Par_SetParam=GetFunction(hDLL,"Par_SetParam")
    Par_SetRecvCallback.Par_SetRecvCallback=GetFunction(hDLL,"Par_SetRecvCallback")
    Par_SetSendCallback.Par_SetSendCallback=GetFunction(hDLL,"Par_SetSendCallback")
    Par_Start.Par_Start=GetFunction(hDLL,"Par_Start")
    Par_StartTo.Par_StartTo=GetFunction(hDLL,"Par_StartTo")
    Par_Stop.Par_Stop=GetFunction(hDLL,"Par_Stop")
    Par_WaitAsBSendCompletion.Par_WaitAsBSendCompletion=GetFunction(hDLL,"Par_WaitAsBSendCompletion") 
  ...
  #_TextLen = 1024 
  #_TextBufLen =  #_TextLen /SizeOf(Character)
  
  Procedure.s CliErrorText(Error.i)
    Protected txt$ = Space(#_TextBufLen)
   
    Cli_ErrorText(Error, @txt$, #_TextLen)  
    ProcedureReturn PeekS(@txt$, -1, #PB_Ascii)
  EndProcedure 
  
  Procedure.s SrvErrorText(Error.i)
    Protected txt$ = Space(#_TextBufLen)
      
    Srv_ErrorText(Error, @txt$, #_TextLen)   
    ProcedureReturn PeekS(@txt$, -1, #PB_Ascii)
  EndProcedure 
  ...
  Procedure.s ParErrorText(Error.i)
    ...
    Par_ErrorText(Error, @txt$, #_TextLen)   
    ProcedureReturn PeekS(@txt$, -1, #PB_Ascii)
  EndProcedure 
  ...
  Procedure.s SrvEventText(*Event)
    ...
    Srv_EventText(*Event, @txt$, #_TextLen)   
    ProcedureReturn PeekS(@txt$, -1, #PB_Ascii) 
  EndProcedure
